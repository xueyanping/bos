...
<script type="text/javascript">
	...
	function doAssociations() {
		...
		if(rows.length != 1){
			//弹出提示
			$.messager.alert("提示信息","请选择一个定区","warigning");
		}else{
			//选中了一个定区
			...
			//发送ajax请求，请求定区Action
			var url_1 = "decidedzoneAction_findAllNotAssociation.action";
			...
			var url_2 = "decidedzoneAction_findAllHadAssociation.action";
	...
	function doDblClickRow(index,data) {
		...
		$('#association_customer').datagrid({
			...
			rownumbers : true,
			striped : true,
			url : "decidedzoneAction_findAllHadAssociation.action?id="+data.id,
			columns : [ [ {
				field : 'id',
				title : '客户编号',
				width : 120,
