 ...
 * Generated at: 2019-05-26 09:11:15 UTC
...
public final class staff_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t$.messager.alert(\"提示信息\",\"请选择要编辑的记录\",\"warning\");\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\tif(rows.length>1){\r\n");
      out.write("\t\t\t$.messager.alert(\"提示信息\",\"只能选中一条记录\",\"warning\");\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//alert(rows[0].id)\r\n");
      out.write("\t\t$.post('staffAction_view.action',{rowId:rows[0].id},function(data){\r\n");
      out.write("\t\t\tif(data!=null){\t\r\n");
      out.write("\t\t\t\t//alert(data);\r\n");
      out.write("\t\t\t\t$('#editStaffWindow').window(\"open\");\r\n");
      out.write("\t\t\t\tvar haspda = data.haspda;\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tif(haspda==1){\r\n");
      out.write("\t\t\t\t//\talert(haspda);\r\n");
      out.write("\t\t\t\t\t$(\"#editStaffWindow [name=haspda]\").prop(\"checked\",true);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tif(haspda==0){\r\n");
      out.write("\t\t\t\t//\talert(haspda);\r\n");
      out.write("\t\t\t\t\t$(\"#editStaffWindow [name=haspda]\").prop(\"checked\",false);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t$(\"#editStaffWindow [name=name]\").val(data.name);\r\n");
      out.write("\t\t\t\t$(\"#editStaffWindow [type=hidden]\").val(data.id);\r\n");
      out.write("\t\t\t\t$(\"#editStaffWindow [name=telephone]\").val(data.telephone);\r\n");
      out.write("\t\t\t\t$(\"#editStaffWindow [name=station]\").val(data.station);\r\n");
      out.write("\t\t\t\t$(\"#editStaffWindow [name=standard]\").val(data.standard);\t\t\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t});\t\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t}else{\r\n");
      out.write("\t\t\t $.messager.confirm(\"确认删除\",\"确定要删除吗？\",function(r){\r\n");
      out.write("\t\t\t\tif(r){\r\n");
      out.write("\t\t\t\t\t//确定，发送请求\r\n");
      out.write("\t\t\t\t\tvar array = new Array();\r\n");
      out.write("\t\t\t\t\tfor(var i = 0;i<rows.length;i++){\r\n");
      out.write("\t\t\t\t\t\tvar staff = rows[i];//staff为json对象\r\n");
      out.write("\t\t\t\t\t\tvar id = staff.id;\r\n");
      out.write("\t\t\t\t\t\tarray.push(id);\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\tvar ids = array.join(\",\");\r\n");
      out.write("\t\t\t\tlocation.href=\"staffAction_deleteBanch.action?ids=\"+ids;\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\tif(rows.length == 0){\r\n");
      out.write("\t\t\t//没有选中记录，弹出提示\r\n");
      out.write("\t\t\t$.messager.alert(\"提示信息\",\"请选择要还原的的记录\",\"warning\");\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\t $.messager.confirm(\"确认删除\",\"确定要还原吗？\",function(r){\r\n");
      out.write("\t\t\t\tif(r){\r\n");
      out.write("\t\t\t\t\t//确定，发送请求\r\n");
      out.write("\t\t\t\t\tvar array = new Array();\r\n");
      out.write("\t\t\t\t\tfor(var i = 0;i<rows.length;i++){\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\tvar ids = array.join(\",\");\r\n");
      out.write("\t\t\t\tlocation.href=\"staffAction_doBack.action?ids=\"+ids;\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\t\t<form id=\"addStaffForm\" action=\"staffAction_addStaff.action\" method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</script>\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"telephone\" class=\"easyui-validatebox\" data-options=\"validType:'telephone'\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>单位</td>\r\n");
      ...
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"id\" class=\"easyui-validatebox\" required=\"true\"/>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>姓名</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"name\" class=\"easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
