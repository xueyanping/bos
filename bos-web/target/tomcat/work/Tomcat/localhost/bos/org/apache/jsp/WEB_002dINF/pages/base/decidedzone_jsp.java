 ...
 * Generated at: 2019-05-26 09:11:22 UTC
...
public final class decidedzone_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t//弹出提示\r\n");
      out.write("\t\t\t$.messager.alert(\"提示信息\",\"请选择一个定区\",\"warigning\");\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\t//选中了一个定区\r\n");
      out.write("\t\t\t$('#customerWindow').window('open');\r\n");
      out.write("\t\t\t$(\"#noassociationSelect\").empty();\r\n");
      out.write("\t\t\t$(\"#associationSelect\").empty();\r\n");
      out.write("\t\t\t//发送ajax请求，请求定区Action\r\n");
      out.write("\t\t\tvar url_1 = \"decidedzoneAction_findAllNotAssociation.action\";\r\n");
      out.write("\t\t\t$.post(url_1,function(data){\r\n");
      out.write("\t\t\t\t//data为json数组\r\n");
      out.write("\t\t\t\t//遍历数组\r\n");
      out.write("\t\t\t\tfor(var i = 0;i<data.length;i++){\r\n");
      out.write("\t\t\t\t\tvar name = data[i].name+\"(\"+data[i].telephone+\")\";\r\n");
      out.write("\t\t\t\t\t$(\"#noassociationSelect\").append(\"<option value='\"+data[i].id+\"'>\"+name+\"</option>\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t//发送ajax请求，请求定区Action，在定区Action中通过crm代理对象完成对于crm服务远程调用获取客户数据\r\n");
      out.write("\t\t\tvar url_2 = \"decidedzoneAction_findAllHadAssociation.action\";\r\n");
      ...
      out.write("\t\t\t\tfor(var i = 0;i<data.length;i++){\r\n");
      out.write("\t\t\t\t\tvar name = data[i].name+\"(\"+data[i].telephone+\")\";\r\n");
      out.write("\t\t\t\t\t$(\"#associationSelect\").append(\"<option value='\"+data[i].id+\"'>\"+name+\"</option>\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\t\trownumbers : true,\r\n");
      out.write("\t\t\tstriped : true,\r\n");
      out.write("\t\t\turl : \"decidedzoneAction_findAllHadAssociation.action?id=\"+data.id,\r\n");
      out.write("\t\t\tcolumns : [ [ {\r\n");
      out.write("\t\t\t\tfield : 'id',\r\n");
      ...
      out.write("\r\n");
      out.write("\t<!-- 添加 修改分区 -->\r\n");
      out.write("\t<div class=\"easyui-window\" title=\"定区添加修改\" id=\"addDecidedzoneWindow\"\r\n");
      ...
      out.write("\t\t\t<form id=\"saveForm\" method=\"post\"\r\n");
      ...
      out.write("\t\t\t\t\t\t<td><input class=\"easyui-combobox\" name=\"staff.id\"\r\n");
      ...
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<table id=\"subareaGrid\" class=\"easyui-datagrid\" border=\"false\"\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t<!-- 查询定区 -->\r\n");
      out.write("\t<div class=\"easyui-window\" title=\"查询定区窗口\" id=\"searchWindow\"\r\n");
      out.write("\t\tcollapsible=\"false\" minimizable=\"false\" maximizable=\"false\"\r\n");
      out.write("\t\tstyle=\"top: 20px; left: 200px\">\r\n");
      out.write("\t\t<div style=\"overflow: auto; padding: 5px;\" border=\"false\">\r\n");
      out.write("\t\t\t<form>\r\n");
      ...
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"staff.station\"\r\n");
      ...
      out.write("\r\n");
      out.write("\t<!-- 关联客户窗口 -->\r\n");
      out.write("\t<div class=\"easyui-window\" title=\"关联客户窗口\" id=\"customerWindow\"\r\n");
      out.write("\t\tcollapsible=\"false\" closed=\"true\" minimizable=\"false\"\r\n");
      out.write("\t\tmaximizable=\"false\"\r\n");
      out.write("\t\tstyle=\"top: 20px; left: 200px; width: 400px; height: 300px;\">\r\n");
      out.write("\t\t<div style=\"overflow: auto; padding: 5px;\" border=\"false\">\r\n");
      out.write("\t\t\t<form id=\"customerForm\"\r\n");
      out.write("\t\t\t\taction=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedzoneAction_assigncustomerstodecidedzone.action\"\r\n");
      ...
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"hidden\" name=\"id\" id=\"customerDecidedZoneId\" />\r\n");
      out.write("\t\t\t\t\t\t\t<select id=\"noassociationSelect\" multiple=\"multiple\" size=\"10\"></select>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"button\" value=\"》》\" id=\"toRight\"><br />\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"button\" value=\"《《\" id=\"toLeft\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t<script type=\"text/javascript\">\r\n");
      out.write("\t\t\t\t\t\t\t\t$(function(){\r\n");
      ...
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</script>\r\n");
      out.write("\t\t\t\t\t\t<td><select id=\"associationSelect\" name=\"customerIds\"\r\n");
      out.write("\t\t\t\t\t\t\tmultiple=\"multiple\" size=\"10\"></select></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"3\"><a id=\"associationBtn\" href=\"#\"\r\n");
      out.write("\t\t\t\t\t\t\tclass=\"easyui-linkbutton\" data-options=\"iconCls:'icon-save'\">关联客户</a>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t</form>\r\n");
